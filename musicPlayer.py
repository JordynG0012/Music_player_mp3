...
Author: Jordyn 7/5/2023

Simple command-line based music player app that can play a standard .mp3 audio file.
*** MUST INSTALL the pygame package before running this APP!!!!!!At command prompt run: pip install pygame --pre
"""
...
while True:
	...
	if menuChoice == "1":
		...
		input("Thank you for using the music player. Press ENTER to close.")
		break		